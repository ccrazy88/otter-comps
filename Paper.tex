...
\section{Standard Hierarchical Model}
    ...
    range of \(E\) to the interval \((0, 0.3)\) in both models. We set the
    burn-in time for the MCMC simulation to 10,000 iterations. Each of these
    parameters are tracked and therefore are estimated.
    ...
    simulation assigns a site a 0 (not occupied) or 1 (occupied) based upon the
    given \(psi\) value.
